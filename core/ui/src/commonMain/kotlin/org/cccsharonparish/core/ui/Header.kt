...
fun Header(
    ...
    Header(headerTitle, navigationIcon, actions, scrollBehavior) {
        onBack()
    }
}
...
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun Header(title: String, navigationIcon: DrawableResource, actions: @Composable RowScope.() -> Unit = {},
           scrollBehavior: TopAppBarScrollBehavior? = null, onBack: () -> Unit) {
    TopAppBar(
        navigationIcon = {
